...
//     file << add.roll << "," << add.name << "," << add.dob.month << "/" << add.dob.day << "/" << add.dob.year << "," << add.age << "," << add.city << "," << add.phone << "," << add.mail << "," << add.father_name << "," << add.parent_phone << "," << add.room << "," << add.hostel_name << endl;
//     file.close();
